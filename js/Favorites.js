...
export class FavoritesView extends Favorites {
  ...
  updateTable() {
    ...
    if (this.isEmpty(this.tbody)) {
      const message = this.createMessageEmptyRow()
      this.tbody.appendChild(message)
    }
  }
